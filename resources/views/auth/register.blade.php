                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="username" type="text" class="form-control" name="username" value="{{ old('last_name') }}" >
                        ...
                        <div class="form-group{{ $errors->has('home_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="home_address" type="text" class="form-control" name="home_address" value="{{ old('home_address') }}" >
